...
radioButtons("group1","Choose your variable domain:",
 ...
 conditionalPanel(
  condition="input.group =='Safety'&& input.source == 'awp'",
 ...
 conditionalPanel(
  ...
  condition="input.group =='Demog' && input.pct_count=='pct'&& input.source !='awp'",
   selectInput("variable2p","Select your variable:",
    ...
    conditionalPanel(
  condition="input.group1 =='Civic Vitality' && input.source =='awp'",
...
#be loaded. 
 variable<-reactive({
     if(input$group1=="Safety" & input$source=="awp"){
     input$variable1awpp
     ...
     input$variable7p
   } else if (input$group1=="Civic Vitality" & input$source =="awp") {
     input$variable8awpp
   }
   })
...
* **Athens Wellbeing Project**: About this data source

Questions about the social atlas can be sent to Dr. Grace Bagwell-Adams (gbagwell@uga.edu) or Dr. Jerry Shannon (jshannon@uga.edu), both at the University of Georgia.