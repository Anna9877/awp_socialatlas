...
#be loaded. 
 variable<-reactive({
     ...
     input$variable7p
   } else if (input$group1=="Civic Vitality" & input$pct_count=="pct"& input$source =="awp") {
     input$variable8awpp
   }
   })
...
Questions about the social atlas can be sent to Dr. Grace Bagwell-Adams () or Dr. Jerry Shannon (jshannon@uga.edu), both at the University of Georgia.