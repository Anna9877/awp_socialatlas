 ...
 conditionalPanel(
  ...
  condition="input.group =='Income' && input.pct_count=='pct'&& input.source !='awp'",
   selectInput("variable5p","Select your variable:",
      ...
      conditionalPanel(
  condition="input.group=='Income' && input.source =='awp' ",
 ...
 conditionalPanel(
  ...
  condition="input.group=='Learning' && input.pct_count=='pct'&& input.source !='awp'",
   selectInput("variable6p","Select your variable:",
    ...
    conditionalPanel(
  condition="input.group=='Learning' && input.source =='awp' ",
...
#be loaded. 
 variable<-reactive({
     ...
     input$variable4p
   } else if (input$group=="Housing" & input$source =="awp") {
     input$variable4awpp
     ...
     input$variable5p
   } else if (input$group=="Income" & input$source =="awp") {
     input$variable5awpp
     ...
     input$variable6p
   } else if (input$group=="Learning" & input$source =="awp") {
     input$variable6awpp
