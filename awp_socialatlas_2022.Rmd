...
radioButtons("source","Select Source of Data",c("Census" = "z", "Athens Wellbeing Project" = "c"),selected="z")
...
########
 #    conditionalPanel(
 #  condition="input.group=='Health' && input.pct_count=='pct'&& input.source =='AWP 3.0 Survey",
...
#be loaded. 
 variable<-reactive({
     ...
     input$variable3p
     ####
   } else if (input$group=="Health" & input$pct_count=="pct" & input$source =="AWP 3.0 Survey") {
     input$variable65p
   #   ####
